...
<div class="col-md-8">
   <div class="panel panel-primary">
        ...
        <div class="panel-heading">
         ...
         <button type="button" class="btn btn-primary pull-right btn-sm" data-toggle="modal" data-target="#addtestcasevalue">Add</button></div>
...
@if(($testcasevalue->count()>0))
        ...
        <tbody>
          ...
          <td> 
            <a style="height: 25px"  data-toggle="modal" data-target="#edittestcase{{ $testcase->id }}"><i class="fa fa-pencil-square-o" style="font-size:22px;color:blue"></i></a> 
  
  <a style="height: 25px" id="deletetestcase" href="{{ url('deletetestcase',$testcase->id) }}" ><i class="fa fa-trash-o" style="font-size:22px;color:red"></i></a> 
       </td>
          </tr>
          @endforeach
